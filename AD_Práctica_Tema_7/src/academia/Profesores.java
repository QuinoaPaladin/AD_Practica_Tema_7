 ...
 * Generation date: Wed Mar 16 20:39:33 2022
 */
...
public class Profesores extends com.matisse.reflect.MtObject {
     ...
     * @see #removeImparte
     */
    public final academia.Clases[] getImparte() {
        return (academia.Clases[])getSuccessors(getImparteRelationship(getMtDatabase()), academia.Clases.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> imparteIterator() {
        return this.<E>successorIterator(getImparteRelationship(getMtDatabase()), academia.Clases.class);
    }
     ...
     * @see #removeImparte
     */
    public final void setImparte(academia.Clases[] succs) {
     ...
     * @see #removeImparte
     */
    public final void prependImparte(academia.Clases succ) {
     ...
     * @see #imparteIterator
     */
    public final void appendImparte(academia.Clases succ) {
     ...
     * @see #imparteIterator
     */
    public final void appendImparte(academia.Clases[] succs) {
     ...
     * @see #imparteIterator
     */
    public void removeImparte(academia.Clases[] succs) {
     ...
     * @see #imparteIterator
     */
    public void removeImparte(academia.Clases succ) {
