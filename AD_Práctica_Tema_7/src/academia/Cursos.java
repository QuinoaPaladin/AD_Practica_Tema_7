...
public class Cursos extends academia.Clases {
     ...
     * @see #removeFecha
     */
    public final java.util.GregorianCalendar getFecha() {
        return getDate(getFechaAttribute(getMtDatabase()));
    }
     ...
     * @see #removeFecha
     */
    public final void setFecha(java.util.GregorianCalendar val) {
        setDate(getFechaAttribute(getMtDatabase()), val);
    }
